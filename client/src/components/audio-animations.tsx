	...
	return (
		<div className="flex flex-col justify-center items-center gap-4 mt-8">
			...
			}
			{
				mode === "user" && (
					<>
						<svg xmlns="http://www.w3.org/2000/svg" className="animate-pulse" width="30" height="30" viewBox="0 0 48 48"><g fill="none" stroke="#000000" strokeLinejoin="round" strokeWidth="4"><rect width="14" height="27" x="17" y="4" fill="#000000" rx="7"/><path strokeLinecap="round" d="M9 23c0 8.284 6.716 15 15 15s15-6.716 15-15M24 38v6"/></g></svg>
						<span className="font-poppins text-sm text-gray-800 animate-pulse">
							I'm listening...
						</span>
					</>
